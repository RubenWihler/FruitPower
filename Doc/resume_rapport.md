...
Le projet a été réalisé en utilisant Unity 2022.3.12f1, un moteur de jeu très populaire pour le développement de jeux vidéo en C#. Le jeu a été conçu pour être joué en réalité virtuelle avec un casque Oculus Quest 2 et des contrôleurs Oculus Touch. Le jeu utilise le XR Interaction Toolkit pour gérer les interactions avec les contrôleurs. Le projet est structuré en plusieurs classes et composants qui interagissent pour créer une expérience de jeu immersive et amusante. Pour assurer un développement efficace, une méthodologie en six étapes a été suivie, en tenant compte des "user stories" pour comprendre au mieux les besoins des utilisateurs. Des scénarios de tests ont été mis en place et exécutés quotidiennement pour garantir que l'intégration de nouvelles fonctionnalités n'affectait pas les fonctionnalités existantes. Une documentation complète du projet a été rédigée pour expliquer le fonctionnement du jeu et faciliter la maintenance future.
